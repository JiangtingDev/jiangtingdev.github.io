...
- 向玩家开放CMI安全传回死亡点功能 /tpbypass 安全传送回死亡点，在/back无法使用时使用（比如死在岩浆里，返回会传送到岩浆附近陆地）
- 向玩家开放CMI世界传送功能权限，用于解决从下界返回主世界会卡边界墙的问题 /world 世界名（仅开放从下界返回world_home、world_resource两个世界的权限，传送回时可能会窒息）
